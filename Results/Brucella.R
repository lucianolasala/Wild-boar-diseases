...
clusters <- st_read("C:/Users/User/Documents/Analyses/Wild boar diseases/Brucelosis/Output/Brucelosis.col.unique.shp")
...
points <- read.csv("C:/Users/User/Documents/Analyses/Wild boar diseases/Brucelosis/Brucella_distance.csv", sep = ",")
...
# In our case, p-value = 6.664e-12, then reject H0 and accept H1
