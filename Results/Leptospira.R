...
ggsave(filename = "C:/Users/User/Documents/Analyses/Wild boar diseases/R_project/Wild-boar-diseases/Maps/Leptospira_clusters.jpg", plot = plot.with.inset, device = "jpeg", path = NULL,
