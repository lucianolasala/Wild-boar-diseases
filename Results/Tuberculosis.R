...
occs <- read.csv("C:/Users/User/Documents/Analyses/Wild boar diseases/Tuberculosis/Output/Tuberculosis.csv", sep = ",", dec = ".") %>%
...
AD <- ggplot() +
  ...
  annotate("text", x = -64.0, y = -40.6, label = "RR = 3,1", color = "black", size = 3.5, fontface = 2)
...
ggsave(filename = "C:/Users/User/Documents/Analyses/Wild boar diseases/R_project/Wild-boar-diseases/Maps/TB_clusters.jpg", plot = plot.with.inset, device = "jpeg", path = NULL,
